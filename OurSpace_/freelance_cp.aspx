<%@ Page Title="" Language="C#" MasterPageFile="~/freelance.Master" AutoEventWireup="true" CodeBehind="freelance_cp.aspx.cs" Inherits="ourspace.freelance_cp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">


<div class="container containerdiv shadow flogin" style="height:300px; width:600px; margin-bottom:50px;">
    
       <center> <h3>Freelance Login</h3> </center>
       <br> 
