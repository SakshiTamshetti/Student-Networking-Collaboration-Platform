<%@ Page Title="" Language="C#" MasterPageFile="~/freelance.Master" AutoEventWireup="true" CodeBehind="peopleint.aspx.cs" Inherits="ourspace.peopleint" %>
        ...
        <h3>
           ...
           <asp:GridView Width="100%" runat="server" id="gvshowninterest" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="interestby" HeaderText="Interest By" />
            </Columns>
