...
namespace ourspace
{
    public partial class answers : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("s_otherqna.aspx");
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
            cmd.CommandText = "insert into anstbl(qid,answer,adate,answerby)values(@qid,@answer,@adate,@answerby)";
            cmd.Parameters.AddWithValue("@qid",qid);
            cmd.Parameters.AddWithValue("@answer", txtanswer.Text);
            cmd.Parameters.AddWithValue("@adate", u.getcdatetime());
            cmd.Parameters.AddWithValue("@answerby",Session["student"].ToString());
            cmd.ExecuteNonQuery();
            txtanswer.Text="";
            loadanswers(qid);
        }
