<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="aproject_list.aspx.cs" Inherits="ourspace.aproject_list" %>
        ...
        <center>
            <asp:GridView runat="server" ID="gvprojectlist" AutoGenerateColumns="False" 
                ...
                <Columns>   
                    ...
                    <asp:BoundField DataField="udate" HeaderText="Upload Date" />
                    <asp:BoundField DataField="puseremail" HeaderText="Student Email id" />
                </Columns>
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <a href=<%#Eval("pfile")%>>Download Project File </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
